...
if(identifier == 0x9325) {
  ...
  tft.setTextSize(1);
  tft.setCursor(90, 220);
  tft.println("Copyright 2016 Ringmaster v1.66");
...
if (motorON==true) {
  ...
  digitalWrite(motorPIN,HIGH);
    ...
    //Hasta que no pase minTempMotor (seg) no paramos el motor para evitar activaciones intermitentes
...
//Lo siguiente sólo lo he dejado como referencia si necesito hacer algún gráfico de uso
//Se pueden borrar sin problema para liberar espacio
...
// No funciona correctamente; el puerto serie se queda ralentizado ¿versión del IDE incompatible/con errores?
